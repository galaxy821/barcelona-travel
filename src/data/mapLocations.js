...
// Barcelona travel map locations with coordinates [lng, lat]
...
const mapLocations = [
  ...
  },
  {
    ...
    nameEn: '포르투갈 음식',
    category: 'restaurant',
    coords: [2.1728, 41.4040],
    address: '사그라다 파밀리아 근처',
  ...
  ============================ */
  {
    ...
    nameEn: '올리브 오일 전문점',
    category: 'shopping',
    coords: [2.1648, 41.3914],
    address: '바르셀로나 내 여러 지점',
    visited: true,
